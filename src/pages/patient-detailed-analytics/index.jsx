...
const PatientDetailAnalytics = () => {
  ...
  const patientData = {
    ...
    avatarAlt:
      'Professional headshot of middle-aged woman with shoulder-length brown hair wearing light blue medical gown',
  ...
  const treatmentEvents = [
    {
      ...
      description:
        'Admitted for post-surgical monitoring following cardiac procedure',
    ...
    },
    {
      ...
      description:
        'Anticoagulant and pain management protocol initiated',
    ...
    },
    {
      ...
      description:
        'Blood work to monitor heart muscle damage markers',
    ...
    },
    {
      ...
      description:
        'Post-procedure assessment and recovery evaluation',
  ...
  const careNotes = [
    ...
    },
    {
      ...
      content:
        'Patient ambulated 50 feet in hallway with minimal assistance. Tolerated activity well with no chest pain or shortness of breath. Vital signs stable throughout.',
    ...
    },
    {
      ...
      content:
        'Reviewed echocardiogram results. Left ventricular function improved compared to pre-procedure baseline. Ejection fraction now 55%. Continue current medication regimen.',
    ...
    },
    {
      ...
      content:
        'Patient reports improved energy levels and decreased fatigue. Appetite improving. Family education provided regarding cardiac rehabilitation program.',
    ...
    },
    {
      ...
      content:
        "Spoke with patient's spouse regarding discharge planning. Discussed home medication management and follow-up appointments. Family expressed understanding and readiness.",
  ...
  const alertHistory = [
    {
      ...
      message:
        'Heart rate exceeded 100 bpm during physical therapy session. Returned to baseline within 5 minutes.',
    ...
    },
    {
      ...
      message:
        'Metoprolol 50mg scheduled for administration at 6:00 PM',
    ...
    },
    {
      ...
      message:
        'Blood pressure reading 145/95 mmHg. Physician notified and additional monitoring initiated.',
    ...
    },
    {
      ...
      message:
        'Cardiac enzyme panel results ready for review',
    ...
    },
    {
      ...
      message:
        'SpO2 dropped to 94% during sleep. Resolved with repositioning and supplemental oxygen.',
  ...
  const careMilestones = [
    {
      ...
      description:
        'Coronary artery blockage cleared with stent placement',
      status: 'completed',
    ...
    },
    {
      ...
      description:
        '24-hour intensive monitoring period completed successfully',
      status: 'completed',
    ...
    },
    {
      ...
      description:
        'Patient able to walk independently without assistance',
      status: 'completed',
      targetDate: '01/07/2026',
      completedDate: '01/07/2026',
      assignedTo: 'Physical Therapy',
      notes:
        'Patient exceeded expectations, walking 100 feet unassisted',
    },
    {
      title: 'Transfer to Step-Down Unit',
      description:
        'Move from ICU to intermediate care unit',
      status: 'inProgress',
    ...
    },
    {
      ...
      description:
        'Enrollment in outpatient cardiac rehab program',
      status: 'pending',
    ...
    },
    {
      ...
      description:
        'Safe discharge to home with follow-up care plan',
      status: 'pending',
  ...
  const getRoleDashboardPath = () => {
    ...
    if (currentRole === 'nurse') {
      return '/nurse-operational-dashboard';
    }
